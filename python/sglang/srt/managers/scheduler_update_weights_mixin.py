...
class SchedulerUpdateWeightsMixin:
    ...
    def post_process_weights(
        self: Scheduler, recv_req: PostProcessWeightsReqInput
    ):
        """Backported from upstream sglang. Optional post-processing for updated
        weights (e.g., FP8 blockscale re-quantization on AMD, Marlin conversion
        on NV)."""
